...
const props = [
	...
	},
	{
		default: '"fail-open"',
		description:
			'Behaviour when the storage is unavailable, passed through to the CacheModule this registers. It does not affect enforcement: the counters behind consume always propagate a storage failure.',
		name: 'onError',
		required: false,
