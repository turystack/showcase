...
function Page() {
	const skill = getFrontendPrimitivesPatternDoc('SKILL')
		...
		<div className="space-y-10">
			<div>
				...
				<p className="mt-3 text-lg text-muted-foreground">
					Skill that encodes how primitive components are written — semantic
					props, internal tv() variants, no className. 8 sections, browsable
					below.
				</p>
			</div>
