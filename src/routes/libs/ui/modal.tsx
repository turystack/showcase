			...
			<div className="space-y-10">
				<div>
					...
					<p className="mt-3 text-lg text-muted-foreground">
						A dialog that overlays the page to focus user attention on a task.
						Always wrap content inside{' '}
						<code className="rounded bg-muted px-1 text-sm">Modal.Content</code>{' '}
						— it provides the portal, overlay, and dialog container.
					</p>
				</div>
...
export const Route = createFileRoute('/libs/ui/modal')({
	component: Page,
})
