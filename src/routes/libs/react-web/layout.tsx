...
const layoutProps = [
	{
		default: 'false',
		description: 'Enables sidebar mode with SidebarProvider.',
		name: 'withSidebar',
		type: 'boolean',
	},
]
      ...
      <Layout.Sidebar bordered>
        ...
        <Layout.Sidebar.Content>
          <Layout.Sidebar.Group>
            <Layout.Sidebar.Group.Label>Application</Layout.Sidebar.Group.Label>
            <Layout.Sidebar.Group.Content>
              <Layout.Sidebar.Menu>
                <Layout.Sidebar.Menu.Item>
                  <Layout.Sidebar.Menu.Button isActive tooltip="Home">
                    <Home />
                    <span>Home</span>
...
// Access sidebar state from any component inside <Layout withSidebar>
...
function Page() {
		...
		<div className="space-y-10">
			<div>
				...
				<p className="mt-3 text-lg text-muted-foreground">
					A full-screen layout with a collapsible sidebar (shadcn primitives),
					slotted header, scrollable content, and declarative menus.
				</p>
			</div>
  ...
  <Layout.Main>
    ...
    <Layout.Footer />
			...
			{/* Layout props */}
			<div className="space-y-4">
				<h2 className="font-display font-semibold text-xl">Layout Props</h2>
...
export const Route = createFileRoute('/libs/react-web/layout')({
	component: Page,
})
