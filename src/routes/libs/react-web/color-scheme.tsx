		...
		<div className="space-y-10">
			<div>
				...
				<p className="mt-3 text-lg text-muted-foreground">
					Manages light, dark, and system color schemes, persisted to
					localStorage. The resolved scheme is applied as a class on the
					document root.
				</p>
			</div>
...
export const Route = createFileRoute('/libs/react-web/color-scheme')({
	component: Page,
})
