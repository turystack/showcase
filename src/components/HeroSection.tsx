	...
	return (
		<section className="relative overflow-hidden py-24 md:py-36">
			<div className="pointer-events-none absolute inset-0">
				<div className="absolute top-1/4 left-1/4 h-96 w-96 animate-glow-pulse rounded-full bg-tury-green/10 blur-[120px]" />
				<div
			...
			<div className="container relative text-center">
				...
				<h1 className="mx-auto mt-8 max-w-4xl font-black font-display text-5xl leading-[1.1] tracking-tight md:text-7xl">
					...
					<span className="bg-gradient-to-r from-tury-green via-tury-purple to-tury-pink bg-clip-text text-transparent">
						the JS ecosystem
					</span>
				</h1>
				...
				<div className="mt-10 flex items-center justify-center gap-4">
					<a
						className="inline-flex items-center gap-2 rounded-lg bg-tury-green px-6 py-3 font-semibold text-background text-sm transition-all hover:shadow-lg hover:shadow-tury-green/25 hover:brightness-110"
						href="#libraries"
					>
						Explore Libraries
						<ArrowRight size={16} />
